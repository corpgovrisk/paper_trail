...
module PaperTrail
  module VersionConcern
    ...
    included do
      ...
      attr_accessible :h_created_at, :item_type, :item_id, :event, :whodunnit, :object, :readable_changes, :object_changes if PaperTrail.active_record_protected_attributes?
